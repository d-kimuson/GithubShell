...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../../.nodebrew/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../../.nodebrew/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../../.nodebrew/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"static/css/main.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../.nodebrew/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/Main.elm":[function(require,module,exports) {
(function(scope){
'use strict';
...
var author$project$Main$BasicDirectory = F2(
	function (a, b) {
		return {$: 'BasicDirectory', a: a, b: b};
	});
var author$project$Main$BasicFile = function (a) {
	return {$: 'BasicFile', a: a};
};
...
var author$project$Main$HiddenFile = function (a) {
	return {$: 'HiddenFile', a: a};
};
var author$project$Main$RootDirectory = function (a) {
	return {$: 'RootDirectory', a: a};
};
...
var author$project$Main$root_dir = author$project$Main$RootDirectory(
	_List_fromArray(
		[
			author$project$Main$FILE(
			author$project$Main$BasicFile('input.txt')),
			author$project$Main$FILE(
			author$project$Main$HiddenFile('.gitignore')),
			author$project$Main$DIRECTORY(
			A2(
				author$project$Main$BasicDirectory,
				'test',
				_List_fromArray(
					[
						author$project$Main$FILE(
...
var author$project$Main$init = {cwd: author$project$Main$root_dir, root: author$project$Main$root_dir};
var author$project$Main$update = F2(
	function (msg, model) {
		return model;
	});
var author$project$Main$fileName = function (file) {
	if (file.$ === 'FILE') {
		if (file.a.$ === 'BasicFile') {
			var filename = file.a.a;
			return filename;
		} else {
			var filename = file.a.a;
			return filename;
...
var author$project$Main$ls = function (directory) {
	switch (directory.$) {
		case 'BasicDirectory':
			var files = directory.b;
			return files;
		case 'HiddenDirectory':
			var files = directory.b;
			return files;
		default:
			var files = directory.a;
			return files;
	}
};
...
var author$project$Main$displayLs = function (directory) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(
			...
			function (f) {
				return A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							author$project$Main$fileName(f))
						]));
			},
			author$project$Main$ls(directory)));
};
var author$project$Main$displayTreeFile = function (file) {
	if (file.$ === 'FILE') {
		return A2(
			elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					elm$html$Html$text(
					author$project$Main$fileName(file))
				]));
	} else {
		var directory = file.a;
		return A2(
			elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					...
					A2(
						elm$core$List$map,
						function (f) {
							return author$project$Main$displayTreeFile(f);
						},
						author$project$Main$ls(directory)))
				]));
	}
};
var author$project$Main$displayTree = function (directory) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$displayLs(author$project$Main$root_dir),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
				...
				author$project$Main$displayTree(author$project$Main$root_dir)
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NotToDo":[]}}}}})}});
...
},{}],"static/js/elm.js":[function(require,module,exports) {
require('../css/main.css');

var _require = require('../../src/Main.elm'),
    Elm = _require.Elm;

var app = Elm.Main.init({
  node: document.getElementById('elm')
});
},{"../css/main.css":"static/css/main.css","../../src/Main.elm":"src/Main.elm"}],"../../../.nodebrew/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.nodebrew/node/v10.15.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","static/js/elm.js"], null)
//# sourceMappingURL=/elm.664ad81b.js.map